...
def train_models():
    ...
    rf_model_path = 'models/random_forest_model100.joblib'
    xgb_model_path = 'models/xgboost_model100.joblib'

    # Load dataset
    file_path = 'C:\\Users\\User\\Desktop\\Final Skripsi\\SKRIPSI\\Mental_Health100.csv'
    ...
    plt.savefig('static/confusion_matrix_rf_training100.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_rf100.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_xgb_training100.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_xgb100.png')
    plt.close()
    ...
    plt.ylim([0, 1])
    plt.savefig('static/accuracy_comparison100.png')
    plt.close()
