...
def train_models():
    ...
    rf_model_path = 'models/random_forest_model5k1.joblib'
    xgb_model_path = 'models/xgboost_model5k1.joblib'

    # Load dataset
    file_path = 'C:\\Users\\User\\Desktop\\Final Skripsi\\SKRIPSI\\Mental_Health_5k(1).csv'
    ...
    plt.savefig('static/confusion_matrix_rf_training5k1.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_rf5k1.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_xgb_training5k1.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_xgb5k1.png')
    plt.close()
    ...
    plt.ylim([0, 1])
    plt.savefig('static/accuracy_comparison5k1.png')
    plt.close()
