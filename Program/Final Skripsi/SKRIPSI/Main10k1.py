...
def train_models():
    ...
    rf_model_path = 'models/random_forest_model10k1.joblib'
    xgb_model_path = 'models/xgboost_model10k1.joblib'

    # Load dataset
    file_path = 'C:\\Users\\User\\Desktop\\Final Skripsi\\SKRIPSI\\Mental_Health_10k(1).csv'
    ...
    plt.savefig('static/confusion_matrix_rf_training10k1.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_rf10k1.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_xgb_training10k1.png')
    plt.close()
    ...
    plt.savefig('static/confusion_matrix_xgb10k1.png')
    plt.close()
    ...
    plt.ylim([0, 1])
    plt.savefig('static/accuracy_comparison10k1.png')
    plt.close()
